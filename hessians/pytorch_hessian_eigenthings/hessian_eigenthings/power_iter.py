...
from pytorch_hessian_eigenthings.hessian_eigenthings.operator import Operator, LambdaOperator
...
def power_iteration(
    ...
    """
    vector_size = operator.size#12933120 # (8689664# amazon) ; (12933120 # ppi) #operator.size  # input dimension of operator  # FIX ME
    print('size', vector_size)
    if init_vec is None:
